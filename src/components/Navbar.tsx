              ...
              <nav className="hidden md:flex items-center space-x-1 lg:space-x-2">
                ...
                <div className="relative">
                  <button
                    ...
                    className={`flex items-center px-3 py-1.5 rounded-xl text-xs sm:text-sm font-bold transition-all ${
                      pathname.startsWith('/questions') || pathname.startsWith('/question-banks')
                        ? 'bg-slate-900 text-white shadow-xs'
                        : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100'
                    }`}
                  >
                    <BookOpen className={`w-4 h-4 mr-1.5 ${
                      pathname.startsWith('/questions') || pathname.startsWith('/question-banks') ? 'text-amber-400' : 'text-slate-400'
                    }`} />
                    <span>Ngân hàng</span>
                  ...
                  {bankDropdownOpen && (
                    <div className="absolute left-0 mt-2 w-56 bg-white border border-slate-200 rounded-2xl shadow-xl p-1.5 z-50 animate-in fade-in zoom-in-95">
                      <Link
                        href="/questions"
