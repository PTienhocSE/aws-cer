# Incident Response — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào phát hiện → phân loại → containment → eradication → recovery → lessons learned; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
PagerDuty/alertmanager, journalctl, kubectl, AWS CLI, tcpdump, incident timeline
...
# 32. Final checklist
- [ ] Trả lời được topic Incident Response bằng ví dụ cụ thể.
