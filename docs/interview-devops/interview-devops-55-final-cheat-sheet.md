# Final Cheat Sheet — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào ôn tập hệ thống từ fundamentals đến cloud, Kubernetes, security, incident và interview; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
flashcards, command index, SLO/RTO/RPO checklist
...
# 32. Final checklist
- [ ] Trả lời được topic Final Cheat Sheet bằng ví dụ cụ thể.
