# Technical Interview — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào trả lời concept, command, debug, design và trade-off theo tầng độ sâu; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
whiteboard, shell, SQL, Kubernetes, Terraform
...
# 32. Final checklist
- [ ] Trả lời được topic Technical Interview bằng ví dụ cụ thể.
