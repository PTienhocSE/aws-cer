# Scenario-based Interview — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào xử lý giả định production bằng assumption, hypothesis, evidence và mitigation; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
runbook, dashboard, logs, rollback, communication
...
# 32. Final checklist
- [ ] Trả lời được topic Scenario-based Interview bằng ví dụ cụ thể.
