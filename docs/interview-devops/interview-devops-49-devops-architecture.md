# DevOps Architecture — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào source-to-production flow, platform boundary, IaC, CI/CD, GitOps và governance; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
git, Terraform, CI runner, artifact registry, Argo CD, policy
...
# 32. Final checklist
- [ ] Trả lời được topic DevOps Architecture bằng ví dụ cụ thể.
