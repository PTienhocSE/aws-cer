# Karpenter Auto-scaling - Exhaustive Interview Preparation Guide

## 1. Mục tiêu học
- Hiểu rõ về Karpenter Auto-scaling trong môi trường Enterprise.
...
- **Enterprise Context:** Karpenter Auto-scaling được áp dụng rộng rãi để mở rộng hệ thống.
- **Enterprise Context (Doanh nghiệp Enterprise):** Áp dụng Karpenter Auto-scaling để đáp ứng JD 60% System + 40% DevOps, tối ưu chi phí và tăng tính ổn định (nhất là hệ thống TOS).
- **Candidate CV Alignment:** Mapping kinh nghiệm AWS, EKS, Docker, K8s, Terraform, ArgoCD vào bối cảnh Karpenter Auto-scaling.

## 4. Kiến trúc / Cách hoạt động (ASCII Diagrams)
```text
[ Client ] --> [ Load Balancer ] --> [ Karpenter Auto-scaling Component A ]
                                     |
                                     +--> [ Karpenter Auto-scaling Component B ]
```
...
- Các tool đặc thù của Karpenter Auto-scaling.
...
```yaml
# Sample config for Karpenter Auto-scaling
server:
  port: 8080 
...
## 14. So sánh
| Feature | Karpenter Auto-scaling | Alternative |
| --- | --- | --- |
...
- **Basic:** Karpenter Auto-scaling là gì?
- **Intermediate:** Nêu cách backup/restore?
- **Advanced:** Làm sao để scale Karpenter Auto-scaling cho 1 triệu RPS?
- **Production/Architecture:** Thiết kế Karpenter Auto-scaling đa vùng (Multi-AZ).
...
- **Q:** Karpenter Auto-scaling dùng để làm gì? -> **A:** Giải pháp cho ...
