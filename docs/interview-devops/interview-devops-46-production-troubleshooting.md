# Production Troubleshooting — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào triage theo scope, first bad timestamp, dependency và rollback; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
top, vmstat, iostat, ss, dig, curl, logs, traces, metrics
...
# 32. Final checklist
- [ ] Trả lời được topic Production Troubleshooting bằng ví dụ cụ thể.
