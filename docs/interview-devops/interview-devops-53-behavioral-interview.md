# Behavioral Interview — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào STAR: situation, task, action, result; ownership, conflict và learning; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
STAR notes, stakeholder map, postmortem
...
# 32. Final checklist
- [ ] Trả lời được topic Behavioral Interview bằng ví dụ cụ thể.
