# Multi-DC System Design - Exhaustive Interview Preparation Guide

## 1. Mục tiêu học
- Hiểu rõ về Multi-DC System Design trong môi trường Enterprise.
...
- **Enterprise Context:** Multi-DC System Design được áp dụng rộng rãi để mở rộng hệ thống.
- **Enterprise Context (Doanh nghiệp Enterprise):** Áp dụng Multi-DC System Design để đáp ứng JD 60% System + 40% DevOps, tối ưu chi phí và tăng tính ổn định (nhất là hệ thống TOS).
- **Candidate CV Alignment:** Mapping kinh nghiệm AWS, EKS, Docker, K8s, Terraform, ArgoCD vào bối cảnh Multi-DC System Design.

## 4. Kiến trúc / Cách hoạt động (ASCII Diagrams)
```text
[ Client ] --> [ Load Balancer ] --> [ Multi-DC System Design Component A ]
                                     |
                                     +--> [ Multi-DC System Design Component B ]
```
...
- Các tool đặc thù của Multi-DC System Design.
...
```yaml
# Sample config for Multi-DC System Design
server:
  port: 8080 
...
## 14. So sánh
| Feature | Multi-DC System Design | Alternative |
| --- | --- | --- |
...
- **Basic:** Multi-DC System Design là gì?
- **Intermediate:** Nêu cách backup/restore?
- **Advanced:** Làm sao để scale Multi-DC System Design cho 1 triệu RPS?
- **Production/Architecture:** Thiết kế Multi-DC System Design đa vùng (Multi-AZ).
...
- **Q:** Multi-DC System Design dùng để làm gì? -> **A:** Giải pháp cho ...
