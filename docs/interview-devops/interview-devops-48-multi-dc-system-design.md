# Multi-DC System Design — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào failure domain, replication, quorum, DNS/GSLB, RPO/RTO và failover; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
route53, health checks, replication status, DR drill
...
# 32. Final checklist
- [ ] Trả lời được topic Multi-DC System Design bằng ví dụ cụ thể.
