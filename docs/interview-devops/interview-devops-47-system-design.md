# System Design - Exhaustive Interview Preparation Guide

## 1. Mục tiêu học
- Hiểu rõ về System Design trong môi trường Enterprise.
...
- **Enterprise Context:** System Design được áp dụng rộng rãi để mở rộng hệ thống.
- **Enterprise Context (Doanh nghiệp Enterprise):** Áp dụng System Design để đáp ứng JD 60% System + 40% DevOps, tối ưu chi phí và tăng tính ổn định (nhất là hệ thống TOS).
- **Candidate CV Alignment:** Mapping kinh nghiệm AWS, EKS, Docker, K8s, Terraform, ArgoCD vào bối cảnh System Design.

## 4. Kiến trúc / Cách hoạt động (ASCII Diagrams)
```text
[ Client ] --> [ Load Balancer ] --> [ System Design Component A ]
                                     |
                                     +--> [ System Design Component B ]
```
...
- Các tool đặc thù của System Design.
...
```yaml
# Sample config for System Design
server:
  port: 8080 
...
## 14. So sánh
| Feature | System Design | Alternative |
| --- | --- | --- |
...
- **Basic:** System Design là gì?
- **Intermediate:** Nêu cách backup/restore?
- **Advanced:** Làm sao để scale System Design cho 1 triệu RPS?
- **Production/Architecture:** Thiết kế System Design đa vùng (Multi-AZ).
...
- **Q:** System Design dùng để làm gì? -> **A:** Giải pháp cho ...
