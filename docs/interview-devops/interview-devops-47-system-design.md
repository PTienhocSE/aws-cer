# System Design — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào SLO, capacity, API, data, cache, queue, HA và graceful degradation; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
sequence diagram, load test, capacity spreadsheet, OpenTelemetry
...
# 32. Final checklist
- [ ] Trả lời được topic System Design bằng ví dụ cụ thể.
