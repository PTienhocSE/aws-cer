# HR Interview - Exhaustive Interview Preparation Guide

## 1. Mục tiêu học
- Hiểu rõ về HR Interview trong môi trường Enterprise.
...
- **Enterprise Context:** HR Interview được áp dụng rộng rãi để mở rộng hệ thống.
- **Enterprise Context (Doanh nghiệp Enterprise):** Áp dụng HR Interview để đáp ứng JD 60% System + 40% DevOps, tối ưu chi phí và tăng tính ổn định (nhất là hệ thống TOS).
- **Candidate CV Alignment:** Mapping kinh nghiệm AWS, EKS, Docker, K8s, Terraform, ArgoCD vào bối cảnh HR Interview.

## 4. Kiến trúc / Cách hoạt động (ASCII Diagrams)
```text
[ Client ] --> [ Load Balancer ] --> [ HR Interview Component A ]
                                     |
                                     +--> [ HR Interview Component B ]
```
...
- Các tool đặc thù của HR Interview.
...
```yaml
# Sample config for HR Interview
server:
  port: 8080 
...
## 14. So sánh
| Feature | HR Interview | Alternative |
| --- | --- | --- |
...
- **Basic:** HR Interview là gì?
- **Intermediate:** Nêu cách backup/restore?
- **Advanced:** Làm sao để scale HR Interview cho 1 triệu RPS?
- **Production/Architecture:** Thiết kế HR Interview đa vùng (Multi-AZ).
...
- **Q:** HR Interview dùng để làm gì? -> **A:** Giải pháp cho ...
