# HR Interview — Cẩm nang phỏng vấn

# 1. Mục tiêu học
Tập trung vào động lực, kỳ vọng, availability, teamwork, compensation và tính trung thực; trả lời được bằng cơ chế, evidence và trade-off thay vì khẩu hiệu.
...
CV, job description, questions for interviewer
...
# 32. Final checklist
- [ ] Trả lời được topic HR Interview bằng ví dụ cụ thể.
